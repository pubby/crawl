...
public:
    ...
    virtual shared_ptr<UI>* get_child_at_offset(int x, int y) = 0;
...
class UIBin : public UIContainer
{
public:
    virtual ~UIBin() {}
    virtual bool on_event(const wm_event& event) override;
    ...
    virtual shared_ptr<UI>* get_child_at_offset(int x, int y) override;
